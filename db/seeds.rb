...
user3 = User.create({name: "Taki", bio: "I love myself", username: "takitaki", password: "takitaki", photo: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki12.jpg"})
user4 = User.create({name: "Wada", bio: "SelfieGrammmmm", username: "wada321", password: "wada321", photo: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada14.jpg"})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/martin2.jpg", user_id: user1.id, caption: 'testing pictures3'})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/martin3.JPG", user_id: user1.id, caption: 'testing pictures3'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/martin1.jpg", user_id: user1.id, caption: 'testing pictures3'})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki11.jpg", user_id: user3.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki13.jpg", user_id: user3.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada11.jpg", user_id: user4.id, caption: 'testing pictures8'})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada13.jpg", user_id: user4.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada15.jpg", user_id: user4.id, caption: 'testing pictures8'})
