...
user3 = User.create({name: "Taki", bio: "I love myself", username: "takitaki", password: "takitaki", photo: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki2.jpg"})
user4 = User.create({name: "Wada", bio: "SelfieGrammmmm", username: "wada321", password: "wada321", photo: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada4.jpg"})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/IMG_0235.JPG", user_id: user1.id, caption: 'testing pictures3'})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/20160710_154302.jpg", user_id: user1.id, caption: 'testing pictures3'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/20160618_154324.jpg", user_id: user1.id, caption: 'testing pictures3'})
...
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki1.jpg", user_id: user3.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/taki3.jpg", user_id: user3.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada1.jpg", user_id: user4.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada2.jpg", user_id: user4.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada3.jpg", user_id: user4.id, caption: 'testing pictures8'})
Photo.create({image: "https://s3.us-east-2.amazonaws.com/selfiegram-dev/users/photos/000/000/002/original/wada5.jpg", user_id: user4.id, caption: 'testing pictures8'})
